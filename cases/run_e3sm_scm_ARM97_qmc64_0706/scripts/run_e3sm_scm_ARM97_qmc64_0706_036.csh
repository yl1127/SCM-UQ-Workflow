...
#######  BEGIN USER DEFINED SETTINGS
  ...
  setenv casename run_e3sm_scm_ARM97_qmc64_0706_036
...
! parameters need to be reset for v3
 ...
 ice_sed_ai = 468.13478
 cldfrc_dp1 = 0.032451611D0
 clubb_ice_deep = 14.e-6
 clubb_ice_sh = 5e-05
 clubb_liq_deep = 8e-06
 clubb_liq_sh = 1e-05
 clubb_C2rt = 0.50879066D0
 zmconv_c0_lnd = 0.0016845464
 zmconv_c0_ocn = 0.0057816411
 zmconv_dmpdz = -1.10488904e-03
 zmconv_ke = 3.46594622E-06
 zmconv_alfa = 0.35588123D0
 zmconv_tau = 12426.898
 effgw_oro = 0.12773101
 linoz_psc_T = 197.5
 seasalt_emis_scale = 0.55D0
 dust_emis_fact = 13.8D0
 clubb_gamma_coef = 0.23338006
 ...
 clubb_use_sgv = .true.
 cldfrc2m_rhmaxi = 1.0625503D0
 clubb_c_K10 = 0.76843279
 effgw_beres = 0.35
 do_tms = .false.
